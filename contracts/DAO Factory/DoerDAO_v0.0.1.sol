...
contract Moloch is ReentrancyGuard {
    ...
    ***************/
    ...
    event ActionProposed(
        ...
        address action,
        string description
    ); //Need to explore Bool[6] as a way of tracking state
    ...
    *****************/
    function proposeAction(
        ...
        require(
            manager != GUILD && manager != ESCROW && manager != TOTAL,
            "manager address cannot be reserved"
        );
        ...
        // TODO Commented out due to compiler errors
        // _proposeAction(
        //     manager,
        //     tributeOffered,
        //     tributeToken,
