...
contract Moloch is ReentrancyGuard {
    ...
    ***************/
    ...
    // EVENTS
    // ***************
    event ActionProposed(address indexed manager, address action, string description); //Need to explore Bool[6] as a way of tracking state
    ...
    struct Action {
        address manager;
        address paymentAllowlist;
        address actionTreasury;
    ...
    *****************/
    function proposeAction(
        ...
        require(manager != address(0), "manager cannot be 0");
        require(manager != GUILD && manager != ESCROW && manager != TOTAL, "manager address cannot be reserved");
        ...
        _ProposeAction(manager, tributeOffered, tributeToken, proposedAction, flags);
